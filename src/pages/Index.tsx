...
const Index = () => {
  ...
  const { data: recentManga, isLoading: recentLoading, isError: recentError, refetch: refetchRecent } = useRecentlyUpdatedManga(recentSection.isVisible ? 1 : 0);
  const { data: allTimeManga, isLoading: allTimeLoading, isError: allTimeError, refetch: refetchAllTime } = useAllTimeTopManga(allTimeSection.isVisible ? 1 : 0);
