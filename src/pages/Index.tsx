 ...
 * Main landing page — clean, functional layout
 */
...
import { useTopAnime, useSeasonalAnime, useTopManga, useAllTimeTopAnime } from "@/hooks/useAnimeData";
...
const Index = () => {
  ...
  return (
    <>
      <SEO
        title={undefined}
        description="Discover your next favorite anime and manga with Bibue. Track your watchlist, explore trending titles, and find top-rated series."
        url="/"
