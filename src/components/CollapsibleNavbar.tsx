  ...
  return (
    <>
      ...
      >
        ...
        <div
          className={cn(
            "md:hidden fixed top-14 left-3 right-3 z-[55] bg-[rgba(20,23,26,0.9)] backdrop-blur-[24px] border border-[rgba(192,192,192,0.2)] rounded-2xl overflow-hidden transition-all duration-200 shadow-lg",
            isMobileMenuOpen
