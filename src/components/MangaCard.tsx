...
export const MangaCard = memo(forwardRef<HTMLDivElement, MangaCardProps>(function MangaCard({ manga, index = 0, variant = "default" }, ref) {
  ...
  return (
    <>
      ...
      >
        <div className="bg-card border border-border/40 rounded-xl sm:rounded-2xl overflow-hidden transition-all duration-200 group-hover/card:bg-secondary group-hover/card:scale-[1.03] will-change-transform transform-gpu">
          {/* Image */}
