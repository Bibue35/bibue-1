    ...
    <footer role="contentinfo" className="border-t border-border/20 bg-background footer-glow-line">
      <div className="container mx-auto px-4 py-12 sm:py-16">
        ...
        <div className="flex flex-col items-center text-center gap-3">
          <Link to="/" className="text-2xl font-sacred font-bold tracking-tight liquid-metal-text">
            Bibue
          </Link>
        ...
        {/* Decorative divider */}
        <div className="mt-8 mx-auto w-32 h-px bg-gradient-to-r from-transparent via-border/40 to-transparent" />
        ...
        <div className="mt-8 flex items-center justify-center gap-4">
          {/* Twitter / X */}
          <span className="w-8 h-8 rounded-full bg-muted/40 flex items-center justify-center text-muted-foreground/50 cursor-default hover-grow" title="Coming soon">
